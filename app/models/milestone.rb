...
class Milestone < Item
  ...
  has_many :detected_test_observation_details, :class_name => 'TestObservationDetail', :foreign_key => 'milestone_id_phase_detected', :include => {:test_observation => [:status, :detail]}, :order => 'statuses.sequence, items.code_id_priority', :dependent => :destroy
